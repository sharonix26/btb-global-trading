    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-[70vh] md:min-h-[78vh] flex items-center overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at 18% 35%, rgba(197,146,42,0.22), transparent 55%)," +
              "radial-gradient(circle at 78% 30%, rgba(12,31,63,0.18), transparent 55%)," +
              "radial-gradient(circle at 65% 80%, rgba(21,45,86,0.14), transparent 60%)," +
